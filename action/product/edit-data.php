		...
		<div class="container">
            ...
            <div class="box">
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<img src="../public/images/products/<?php echo $p->product_image ?>" width="100px">
					...
					if(isset($_POST['submit'])){
						...
						if($filename != ''){
							...
							if(!in_array($type2, $tipe_diizinkan)){
								...
								unlink('../../public/images/products/'.$foto);
								move_uploaded_file($tmp_name, '../../public/images/products/'.$newname);
								$namagambar = $newname;
							}
